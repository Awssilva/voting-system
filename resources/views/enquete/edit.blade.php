...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('enquete.update', $enquete->id) }}" method="POST">
            @csrf
            @method('PUT')
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" id="inputTitulo" class="form-control" name="titulo" placeholder="Digite o título" value="{{ $enquete->titulo }}" required>
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="date" id="inputDataInicio" class="form-control" name="data_inicio" value="{{ $enquete->data_inicio }}" required >
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="date" id="inputDataFim" class="form-control" name="data_fim" value="{{ $enquete->data_fim }}" required>
            </div>
        </div>
        ...
        <div id="opcoes">
            @foreach($opcoes as $key => $opcao)
                <div class="cont mb-3 row" id="n{{ $key +1 }}">
                    <label for="inputOpcao{{ $key  +1 }}" class="col-sm-2 col-form-label">Opção {{ $key + 1 }}</label>
                    <div class="col-sm-10">
                        <input type="text" id="inputOpcao{{ $key  +1 }}" class="form-control" name="opcoes[]" placeholder="Digite a opção" value="{{ $opcao->opcao }}" required>
                    </div>
                </div>
